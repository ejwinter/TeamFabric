...
Lorem ipsum dolor sit amet. Add FHIR R4 resource parsing and mapping to the ingestion layer alongside existing HL7v2 support. Duis aute irure dolor in reprehenderit in voluptate velit.

## Acceptance Criteria

- Lorem ipsum FHIR R4 resources parsed and validated
- Consectetur adipiscing HL7v2 and FHIR pipelines coexist
- Sed do eiusmod ADT events mapped to FHIR Encounter resources
